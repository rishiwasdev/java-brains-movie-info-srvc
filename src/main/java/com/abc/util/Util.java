...
public class Util {
	...
	/** returns total 'numWords' random words */
	public static String randomName(int numWords) {
		int maxWordLength = 6;
		StringBuilder sb = new StringBuilder();
		for (int i = 0; i < numWords; i++) {
			sb.append(asciiValue(65 + Util_Elementary.randomNum(25))).append(randomStrLowerCase(Util_Elementary.randomNum(maxWordLength - 1))).append(" ");
		}
